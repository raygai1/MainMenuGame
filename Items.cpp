...
Item generateRandomItem() { //pulls a random item from the list
    ...
    switch (roll) {
        //+atk weapons
    case 0: return Item("Sword", "A sharp blade.", ItemType::Weapon, getRandomNumber(1, 5));
    case 1: return Item("Axe", "Good for chopping.", ItemType::Weapon, getRandomNumber(2, 3));
    case 2: return Item("Mace", "Heavy and crushing.", ItemType::Weapon, getRandomNumber(2, 4));
    case 3: return Item("Golden Knife", "Shiny but deadly.", ItemType::Weapon, getRandomNumber(2, 5));
        // Armor (+defense)
    case 4: return Item("Iron Helmet", "Protects your head.", ItemType::Armor, getRandomNumber(1, 3));
    case 5: return Item("Chainmail", "Sturdy and reliable.", ItemType::Armor, getRandomNumber(2, 7));
    ...
    case 7: return Item("Magic Cloak", "Mysterious defense aura.", ItemType::Armor, getRandomNumber(2, 5));
        //-atk/def cursed
    case 8: return Item("Cursed Bow", "A bow that whispers to you.", ItemType::CursedWeapon, -getRandomNumber(1, 5));
    ...
    case 16: return Item("Pile of Gold", "Some shiny coins!", ItemType::Gold, getRandomNumber(20, 250));
